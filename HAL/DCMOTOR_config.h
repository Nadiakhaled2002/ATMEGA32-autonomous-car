...
#define H_EN1_PORT             DIO_PORTD
#define H_EN1_PIN              DIO_PIN4
...
#define B_1A_PIN              DIO_PIN5

#define B_2A_PORT             DIO_PORTB
#define B_2A_PIN              DIO_PIN6

#define A_1A_PORT             DIO_PORTB
#define A_1A_PIN              DIO_PIN7

#define A_2A_PORT             DIO_PORTC
#define A_2A_PIN              DIO_PIN1
